...
var Multiselect = function (_Component) {
  ...
  _createClass(Multiselect, [{
    ...
    value: function _renderListItems() {
      ...
      return this.state.filteredItems.map(function (item, i) {
        ...
        return _react2.default.createElement(
          ...
          _react2.default.createElement(
            'span',
            { className: _this2.props.classNames.label, ref: 'msLabel' + i },
            item.label
          ),
          _react2.default.createElement('span', { className: _this2.props.classNames.checkbox, ref: 'msCheck' + i })
        );
      });
    }
  }, {
    ...
    value: function _handleDocumentMouseDown(e) {
      ...
      if (e && e.path && !e.path.find(function (n) {
      ...
      } else if (e && e.path && e.path.find(function (n) {
        return n === itemsNode;
      })) {
        e.preventDefault();
      } else {
        var isItemCheckBox = this.state.filteredItems.reduce(function (acc, item, i) {
          return acc || e.target === _reactDom2.default.findDOMNode(_this3.refs['msCheck' + i]);
        }, false);
        var isItemLabel = this.state.filteredItems.reduce(function (acc, item, i) {
          return acc || e.target === _reactDom2.default.findDOMNode(_this3.refs['msLabel' + i]);
        }, false);
    ...
    value: function _handleItemMouseMove(index) {
      ...
      return function () {
        if (index !== _this5.state.hoverIndex) {
          _this5.setState({ hoverIndex: index });
        }
      };
    }
  }, {
